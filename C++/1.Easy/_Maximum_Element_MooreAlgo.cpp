/* 
	* Finds the Maximum element(an element which has atleast n/2 occurrence) 
	* from an array of element using moore Algorithm
...
/// @param arr array of elements
/// @param candidate candidate for majority element
